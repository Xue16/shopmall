                ...
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a href="#"
                    ...
                    <span
                      v-show="isOne"
                      class="iconfont"
                      :class="{ 'icon-xiangshang': isAsc, 'icon-paixu': isDesc, }"
                    ></span>
                  </a>
                </li>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      // continues:state=>state.search.searchList.totalPage,
    })
  },
  methods: {
    getData() {
    ...
    changeOrder(text) {
      ...
      if (originflag === text) {
        this.searchParams.order = `${text}:${originOrder==="desc"?"asc":"desc"}`;
      }else{
        this.searchParams.order = `${text}:${"desc"}`;
      }
      this.getData();
    },
    getPageNo(PageNo){
